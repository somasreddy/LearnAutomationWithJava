...
public class GetJobsFromGit {
	...
	public static void main(String[] args) throws InterruptedException, IOException 
	{
		...
		/*
		 *  lst.add(ICU); lst.add(DWK); lst.add(CMP); lst.add(MRD); lst.add(PAP_PD);lst.add(CMP);
		 * lst.add(PAP_PH); lst.add(PAP_SH); lst.add(PAP_FH); lst.add(PAP_PMH);
		 * lst.add(COL);lst.add(PHA);
		...
		lst.add(PAP_FH); 
		lst.add(PAP_PMH);
		driver.navigate().to("https://github.cerner.com/EggPlant/");
		driver.manage().window().maximize();
		driver.findElement(By.xpath("//a[contains(text(),'Sign�in')]")).click();
		
		driver.findElement(By.xpath("//input[@id='login_field']")).sendKeys("VS065203");
		driver.findElement(By.xpath("//input[@id='password']")).sendKeys("soma@ceR#");
