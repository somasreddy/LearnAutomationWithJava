...
public class EggPlantJob_DWK {
	public static void main(String[] args) throws InterruptedException 
    {
		...
		options.addArguments("headless");
          ...
          driver.navigate().to("https://github.cerner.com/EggPlant/IPDev-Millennium-ClinicianList/tree/master/IPDev-Millennium-ClinicianList.suite/Scripts/Workflows");
          ...
          for(int i=0;i<arrList.size();i++)
          {
              ...
              for(String p:parts) {
              	...
              	driver.findElement(By.xpath("//input[@placeholder='Type to autocomplete']")).sendKeys("EggPlant - Dummy");
              	...
              	driver.findElement(By.xpath("//*[@id=\"main-panel\"]/div/div/div/form/table/tbody/tr[63]/td[3]/input")).clear();
              	driver.findElement(By.xpath("//*[@id=\"main-panel\"]/div/div/div/form/table/tbody/tr[63]/td[3]/input")).sendKeys("Eggplantnode_DWK");
              	...
              	driver.findElement(By.xpath("//div/table/tbody/tr/td/textarea[@name='command']")).sendKeys(Job_Pref+p+Job_Suf);
              	Thread.sleep(1000);
              	driver.findElement(By.xpath("//input[@name='_.recipients']")).clear();
              	driver.findElement(By.xpath("//input[@name='_.recipients']")).sendKeys("Kartheek.Donekal@cerner.com,Mamatha.Balla@cerner.com");
              	Thread.sleep(1000);
