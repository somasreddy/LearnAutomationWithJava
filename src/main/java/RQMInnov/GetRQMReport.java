...
public class GetRQMReport {
	...
	public static void main(String[] args) throws Exception {
		...
		for (int i = 1; i <= LastRow; i++) {
			...
			System.out.println(gRR.searchAndSelectTestPlan(chromeDriver, gRR.GetTPNameFromExcel(wb,sheetName,i,0)+releaseNum));
		}
		...
		WebElement exportToCSV=(WebElement)wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//td/div[@title='1 minute ago']/../../td/a[contains(@href,'IPrintService')]")));
	...
	public String GetTPNameFromExcel(Workbook wb, String Sheet, int Row, int Col) { return wb.getSheet(Sheet).getRow(Row).getCell(Col).toString(); }

	//	public String GetTPFromExcel(Workbook wb, String Sheet, int Row) { return wb.getSheet(sheetName).getRow(Row).getCell(0).toString(); }
